...
const SideBar = () => {
    return (
        <div className='h-screen px-4 max-sm:px-1 max-sm:pt-1 space-y-2 sm:pt-2 overflow-hidden w-[25%]  max-sm:w-[50%]'>
            ...
            <div className='h-[90%] max-sm:h-[90%] w-[100] max-sm:w-[100%] bg-gray-300 space-y-5 sm:pt-2'>
